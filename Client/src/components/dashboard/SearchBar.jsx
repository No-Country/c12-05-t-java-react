  ...
  return (
    <div className="col col-span-3 border-2 border-gray-400">
      <div className="flex w-full h-full items-center justify-center gap-5">
        ...
        <button className="px-4 bg-yellow-200 text-gray-900 rounded-md h-3/6 w-1/6 flex justify-center items-center gap-2 hover:text-yellow-200 hover:bg-gray-900 transition-all duration-300 ease-in-out cursor-pointer">
